...
api_id = int(os.environ.get("18612804"))
api_hash = os.environ.get("5ec02c3549afab2ec704ce7c497fa19e")
bot_token = os.environ.get("5168699464:AAHPB0M0ffURDAEF2khgTYp-uritky82PDw")
...
async def start(event):
  await event.reply("**🌀LuciTaggerBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
		      ...
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/deltataggerbot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/deltsup')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/Turanbots')],
		      [Button.url('Developer👨🏻‍💻', 'https://t.me/Turanammaafkolan')],
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', 'https://t.me/deltataggerbot?startgroup=a')],
                      [Button.url('Support👨‍💻', 'https://t.me/deltasup')],
                      [Button.url('Resmi Kanal🔖', 'https://t.me/turanbots')],
		      [Button.url('Developer🧑‍🔧', 'https://t.me/Turanammaafkolan')],
                    ),
                    link_preview=False
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @deltaTaggerBot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @deltaTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/Deltataggerbot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @Turanammaafkolan bilgi alabilirsin <<")
